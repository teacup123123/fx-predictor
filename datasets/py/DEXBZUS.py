...
usd_in_brl_daily = readpickle(__file__.split('.')[0])
"""
...
Suggested Citation:
Board of Governors of the Federal Reserve System (US), Brazilian Reals to U.S. Dollar Spot Exchange Rate [DEXBZUS], retrieved from FRED, Federal Reserve Bank of St. Louis; https://fred.stlouisfed.org/series/DEXBZUS, December 18, 2021.
"""